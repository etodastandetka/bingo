...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 flex justify-center items-center overflow-hidden">
            ...
            {bottomNavItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-blue-400 rounded-full"></div>
                  )}
                </Link>
              )
            })}
