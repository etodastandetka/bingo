    ...
    <div className="py-4">
      ...
      <div className="bg-gray-800 bg-opacity-50 rounded-xl p-4 mb-4 border border-gray-700 backdrop-blur-sm">
        ...
        <form onSubmit={handlePeriodSubmit} className="flex gap-2">
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-xl hover:from-blue-600 hover:to-blue-700 font-medium text-sm whitespace-nowrap"
          >
            Применить
          </button>
        </form>
