    ...
    <div className="py-4">
      ...
      {wallets.length > 0 && (
        <div className="mb-4 bg-gray-800 bg-opacity-50 rounded-xl p-4 border border-gray-700 backdrop-blur-sm">
          ...
          <select
            ...
            className="w-full bg-gray-900 text-white border border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
            style={{
      ...
      {wallets.length === 0 ? (
        <div className="text-center py-12 text-gray-400">
          ...
          <button
            onClick={handleAddNew}
            className="bg-blue-500 text-black px-6 py-3 rounded-xl hover:bg-blue-600 font-medium"
          >
            Добавить кошелек
          </button>
        </div>
          ...
          {wallets.map((wallet) => (
            <div
              ...
              className={`bg-gray-800 bg-opacity-50 rounded-xl p-4 border-2 backdrop-blur-sm ${
                wallet.isActive ? 'border-blue-500' : 'border-gray-700'
              }`}
            >
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {wallet.isActive && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-500 text-black">
                        Активен
                      </span>
                    )}
                  </div>
          ...
          <div className="relative bg-gray-800 rounded-xl shadow-xl max-w-md w-full p-6 border border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-3 mt-6">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-black rounded-xl hover:from-blue-600 hover:to-blue-700 font-medium"
                >
