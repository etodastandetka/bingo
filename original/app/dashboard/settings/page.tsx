  ...
  return (
    <div className="py-4">
      ...
      <button
        ...
        disabled={saving}
        className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-black px-4 py-3 rounded-xl hover:from-blue-600 hover:to-blue-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
      >
