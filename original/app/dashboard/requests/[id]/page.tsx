          ...
          <div className="bg-gray-800 rounded-2xl p-6 mx-4 w-full max-w-md border border-gray-700">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-black rounded-lg font-medium transition-colors"
              >
                Найти
              </button>
              <button
      ...
      <div className="mx-4 mb-4 bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className={`text-3xl font-bold ${showMinus ? 'text-red-500' : (isDeposit ? 'text-blue-500' : 'text-red-500')}`}>
      ...
      {(request.status === 'deferred' || request.status === 'pending') && (
        <div className="mx-4 mb-4 flex space-x-3">
          <button
            ...
            className="flex-1 bg-blue-500 hover:bg-blue-600 text-black font-bold py-3 px-4 rounded-xl transition-colors flex items-center justify-center space-x-2"
          >
            ...
            {transactions.map((transaction) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <p className={`text-lg font-bold ${transaction.isDeposit ? 'text-blue-500' : 'text-red-500'}`}>
