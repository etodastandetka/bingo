    ...
    <div className="py-4">
      ...
      <div className="mx-4 mb-6 bg-gray-800 rounded-2xl p-6 border border-gray-700">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
        >
