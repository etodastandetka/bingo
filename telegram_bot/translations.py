...
TRANSLATIONS = {
    'ru': {
        ...
        'deposit': {
            ...
            'qr_payment_info': '💰 Сумма: {amount:.2f} KGS\n🎰 Казино: {casino}\n🆔 ID: {account_id}\n\n📸 Отсканируйте QR код и выберите банк:',
            'select_bank': 'Выберите банк для оплаты:',
            'send_receipt': '✅ Банк выбран: {bank}\n\n📸 Теперь отправьте фото чека об оплате:',
...
Ваша заявка будет обработана в ближайшее время!''',
    ...
    'ky': {
        ...
        'deposit': {
            ...
            'send_receipt': '✅ Банк тандалды: {bank}\n\n📸 Эми төлөө чегинин сүрөтүн жөнөтүңүз:',
